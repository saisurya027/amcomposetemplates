...
def generateheaderquestion(expirytime):
    ...
    col1 = {'width': '32px', constants.type: 'Column', 'bleed': False, constants.items: []}
    ...
    col2 = {'width': 'stretch', constants.type: 'Column', 'bleed': False, constants.items: []}
...
def generateheader():
    header = {constants.type: constants.Container, constants.style: constants.emphasis, constants.items: []}
    items = {constants.type: 'ColumnSet', 'columns': []}
    col1 = {'width': '32px', 'type': 'Column', 'bleed': False, constants.items: []}
    col1item = {constants.type: 'Image', 'width': '26px', 'horizontalAlignment': 'Center',
                'url': 'data:image/png;base64,',
                'altText': 'Trello Logo'}
    col1[constants.items].append(col1item)
    ...
    col2[constants.items].append(col2item)
    items['columns'].append(col2)
    col3 = {'width': 'auto', 'type': 'Column', 'bleed': False, constants.items: []}

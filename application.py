...
def generateheaderquestion(expirytime):
    header = {constants.type: constants.Container, 'style': 'emphasis', 'items': []}
    items = {constants.type: 'ColumnSet', 'columns': []}
    col1 = {'width': '32px', constants.type: 'Column', 'bleed': False, 'items': []}
    col1item = {constants.type: 'Image', 'width': '26px', 'horizontalAlignment': 'Center',
    ...
    col2 = {'width': 'stretch', constants.type: 'Column', 'bleed': False, 'items': []}
...
def generatebody(qid):
    body = {constants.type: constants.Container, 'padding': {'left': 'padding', 'right': 'padding'}, 'items': []}
...
def generateaction(qid):
    body = {constants.type: constants.Container, 'padding': {'left': 'padding', 'right': 'padding', 'bottom': 'padding'}, 'items': []}
...
def generatestatistics(qid, question, Options, results):
    ...
    for i in range(len(Options) - 1):
        ...
        titems = {constants.type: 'Image', 'spacing': 'none', 'padding': 'none', 'padding': 'none', 'height': '25px',
